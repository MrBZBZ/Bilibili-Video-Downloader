...
# 如何获取我的B站Cookie🤔？：
* ## 1.您可以通过手机扫码进行登录，从而获取Cookie
点击扫码登录按钮，您将看到一个被展示的二维码：  
 ![GUI](qr.jpg "qr.jpg")  
 用手机端的Bilibili扫码并登录后会出现成功提示  
 这时您的Cookie就获取到了，可以进行视频下载
 温馨提示：二维码获取自B站官方接口，完全正规(源码里面也可以看到)
 * ## 2.您可以通过已登录B站的浏览器获取Cookie
